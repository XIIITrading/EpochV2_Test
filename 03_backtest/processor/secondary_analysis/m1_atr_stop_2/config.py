...
M1 ATR Stop Processor v2 - Configuration
XIII Trading LLC
================================================================================

Self-contained configuration for the M1 ATR Stop calculation module.
Evaluates trades using M1 ATR as the stop distance (1R) and tracks
...
- m1_indicator_bars_2: Pre-computed atr_m1 at entry candle time
