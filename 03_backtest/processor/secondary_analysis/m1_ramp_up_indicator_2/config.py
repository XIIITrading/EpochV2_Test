...
M1 Ramp-Up Indicator Processor v2 - Configuration
XIII Trading LLC
================================================================================

Self-contained configuration for the m1_ramp_up_indicator_2 processor.
Joins trades_2 + m5_atr_stop_2 + m1_indicator_bars_2 to build a 25-bar
ramp-up view of indicators before each trade entry.
...
TARGET_TABLE = "m1_ramp_up_indicator_2"

# =============================================================================
# RAMP-UP PARAMETERS
# =============================================================================
RAMP_UP_BARS = 25  # Number of M1 bars before entry
